/*! chessboard.js v1.0.0 | (c) 2019 Chris Oakman | MIT License chessboardjs.com/license */ ! function() {
    ...
    function u(e) {
        if(e.length == 2){
          return re(e) && -1 !== e.search(/^[bw][KQRNBP@#%&*+012345678]$/)
          
        }else{
          return re(e) && -1 !== e.search(/^[bw][0123456789][0123456789]$/)
        }
        // allowed piece type
    }
    ...
    function ae(e) {
        ...
        for (var n = 0; n < 8; n++)
            if (8 !== r[n].length || -1 !== r[n].search(/[^kqrnbpzKQRNBPZ1]/)) return !1;
            //allowed fen notation
        return !0
    }
    ...
    H.alpha = "alpha-d2270", H.black = "black-3c85d", H.board = "board-b72b1", H.chessboard = "chessboard-63f37", H.clearfix = "clearfix-7da63", H.highlight1 = "highlight1-32417", H.highlight2 = "highlight2-9c5d2", H.notation = "notation-322f9", H.numeric = "numeric-fc462", H.piece = "piece-417db", H.row = "row-5277c", H.sparePieces = "spare-pieces-7492f", H.sparePiecesBottom = "spare-pieces-bottom-ae20f", H.sparePiecesTop = "spare-pieces-top-4028b", H.square = "square-55d63", H.white = "white-1e1d7", window.Chessboard = function(e, f) {
        ...
        function D(e) {
            // f.onMouseoverSquare("test")
            // f.onDrop(e,e)
            // if(e.target.classList[2]){
              
            //   f.onDrop(e.target.classList[2][7] + e.target.classList[2][8],e.target.classList[2][7] + e.target.classList[2][8])
            // }
            if (f.draggable) {
